...
import com.xwz.control.DataController;
...
public class Application_test {
    ...
    public void DataTest() {
        LocalDataService bean = context.getBean(LocalDataService.class);
        bean.Download_Pic("萝莉","all","/home/xy/aaa");
    }
...
/*    PoolingHttpClientConnectionManager pool=new PoolingHttpClientConnectionManager();
        ...
        try {
            ...
            String name = Application_test.randomName(true, 3);
            pairs.add(new BasicNameValuePair("name", name));
            String tel = Application_test.getTel();
            pairs.add(new BasicNameValuePair("hometel",tel ));
            System.err.println(name+"_"+tel);
